...
# Create client for messaging publishing support
PS_SLACK_WEBHOOK = os.environ.get("PS_SLACK_WEBHOOK", None)
assert PS_SLACK_WEBHOOK is not None, "Unable to find required environment variable PS_SLACK_WEBHOOK"
...
assert DE_SLACK_WEBHOOK is not None, "Unable to find required environment variable DE_SLACK_WEBHOOK"
...
assert SE_SLACK_WEBHOOK is not None, "Unable to find required environment variable SE_SLACK_WEBHOOK"
...
assert DS_SLACK_WEBHOOK is not None, "Unable to find required environment variable DS_SLACK_WEBHOOK"
