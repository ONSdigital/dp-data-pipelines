...
All of the scenarios below assume that the data producer is submitting a data.csv file. Currently supported data file formats are CSV, XML, XLSX, CSDB. The relevant error should be raised for any of these file types.
